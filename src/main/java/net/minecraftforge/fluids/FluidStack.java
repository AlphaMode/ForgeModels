...
public class FluidStack
{
    ...
    public FluidStack(Fluid fluid, int amount)
    {
        ...
        else if (Registry.FLUID.getKey(fluid) == null)
        {
            LOGGER.fatal("Failed attempt to create a FluidStack for an unregistered Fluid {} (type {})", Registry.FLUID.getKey(fluid), fluid.getClass().getName());
    ...
    {
        buf.writeVarInt(Registry.FLUID.getId(getFluid()));
    ...
    {
        Fluid fluid = Registry.FLUID.byId(buf.readVarInt());
