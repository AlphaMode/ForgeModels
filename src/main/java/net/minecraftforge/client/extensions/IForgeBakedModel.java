...
public interface IForgeBakedModel
{
    ...
    {
        Transformation tr = TransformationHelper.toTransformation(self().getTransforms().getTransform(cameraTransformType));
        if(!((IForgeTransformation)(Object)tr).isIdentity()) {
            ((IForgeTransformation)(Object)tr).push(poseStack);
        }
        return self();
    }
