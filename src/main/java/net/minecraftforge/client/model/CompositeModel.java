...
public class CompositeModel implements IDynamicBakedModel
{
    ...
    public List<BakedQuad> getQuads(@Nullable BlockState state, @Nullable Direction side, @Nonnull Random rand, @Nonnull IModelData extraData)
    {
        ...
        {
            quads.addAll(((IForgeBakedModel)entry.getValue()).getQuads(state, side, rand, CompositeModelData.get(extraData, entry.getKey())));
        }
        return quads;
    }
    ...
    public IModelData getModelData(@Nonnull BlockAndTintGetter world, @Nonnull BlockPos pos, @Nonnull BlockState state, @Nonnull IModelData tileData)
    {
        ...
        for(Map.Entry<String, BakedModel> entry : bakedParts.entrySet())
        {
            composite.putSubmodelData(entry.getKey(), ((IForgeBakedModel)entry.getValue()).getModelData(world, pos, state, ModelDataWrapper.wrap(tileData)));
        }
        return composite;
    }
