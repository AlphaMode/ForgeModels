 ...
 */
public class CompositeModelState implements ModelState, IForgeModelState
{
    ...
    {
        return ((IForgeModelState)first).getPartTransformation(part).compose(((IForgeModelState)second).getPartTransformation(part));
    }
