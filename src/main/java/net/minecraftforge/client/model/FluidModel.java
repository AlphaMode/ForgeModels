...
public final class FluidModel implements IModelGeometry<FluidModel>
{
    ...
    public BakedModel bake(IModelConfiguration owner, ModelBakery bakery, Function<Material, TextureAtlasSprite> spriteGetter, ModelState modelTransform, ItemOverrides overrides, ResourceLocation modelLocation)
    {
        ...
        return new CachingBakedFluid(
                ...
                modelLocation,
                handler.getFluidColor(null, null, fluid.defaultFluidState()),
                handler.getFluidSprites(null, null, fluid.defaultFluidState())[0],
                handler.getFluidSprites(null, null, fluid.defaultFluidState())[1],
                null,
                false,
                null
        );
    ...
    private static class BakedFluid implements BakedModel, IForgeBakedModel
    {
        ...
        private BakedQuad buildQuad(Direction side, TextureAtlasSprite texture, boolean flip, boolean offset, VertexParameter x, VertexParameter y, VertexParameter z, VertexParameter u, VertexParameter v)
        {
            ...
            boolean hasTransform = !((IForgeTransformation)(Object)transformation).isIdentity();
