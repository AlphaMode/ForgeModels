...
public class BlockModelConfiguration implements IModelConfiguration
{
    ...
    {
        return owner.parent != null && customGeometry == null ? ((BlockModelEx)owner.parent).ForgeModels$getCustomData().getCustomGeometry() : customGeometry;
    }
    ...
    {
        return owner.parent != null && customModelState == null ? ((BlockModelEx)owner.parent).ForgeModels$getCustomData().getCustomModelState() : customModelState;
    }
    ...
    public boolean getPartVisibility(IModelGeometryPart part, boolean fallback)
    {
        return owner.parent != null && !visibilityData.hasCustomVisibility(part) ?
                ((BlockModelEx)owner.parent).ForgeModels$getCustomData().getPartVisibility(part, fallback):
