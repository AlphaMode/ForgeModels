...
public final class DynamicBucketModel implements IModelGeometry<DynamicBucketModel>
{
    ...
    public BakedModel bake(IModelConfiguration owner, ModelBakery bakery, Function<Material, TextureAtlasSprite> spriteGetter, ModelState modelTransform, ItemOverrides overrides, ResourceLocation modelLocation)
    {
        ...
        TextureAtlasSprite fluidSprite = fluid != Fluids.EMPTY ? handler.getFluidSprites(null, null, fluid.defaultFluidState())[0] : null;
...
//        }
        ...
        if (fluidMaskLocation != null && fluidSprite != null)
        {
            ...
            if (templateSprite != null)
            {
                ...
                int color = tint ? handler.getFluidColor(null, null, fluid.defaultFluidState()) : 0xFFFFFFFF;
                builder.addQuads(ItemLayerModel.getLayerRenderType(/*luminosity > 0*/false), ItemTextureQuadConverter.convertTexture(transform, templateSprite, fluidSprite, NORTH_Z_FLUID, Direction.NORTH, color, 1, 0));
                builder.addQuads(ItemLayerModel.getLayerRenderType(/*luminosity > 0*/false), ItemTextureQuadConverter.convertTexture(transform, templateSprite, fluidSprite, SOUTH_Z_FLUID, Direction.SOUTH, color, 1, 0));
            }
        }
