...
{
    static final Logger logger = LogManager.getLogger("fabric" + ".B3DModel");
    ...
    public static class Vertex
    {
        ...
        public Vertex bake(Mesh mesh, Function<Node<?>, Matrix4f> animator)
        {
            ...
            ((IForgeTransformation)(Object)trsr).transformPosition(pos);
            pos.normalize();
            ...
            if(this.normal != null)
            {
                ...
                ((IForgeTransformation)(Object)trsr).transformNormal(rNormal);
            }
