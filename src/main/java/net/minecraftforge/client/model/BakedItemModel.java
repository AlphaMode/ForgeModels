...
public class BakedItemModel implements BakedModel, IForgeBakedModel
{
    ...
    private static boolean hasGuiIdentity(ImmutableMap<TransformType, Transformation> transforms)
    {
        ...
        return guiTransform == null || ((IForgeTransformation)(Object)guiTransform).isIdentity();
    }
    ...
    public BakedModel handlePerspective(TransformType type, PoseStack poseStack)
    {
        ...
        {
            return ((IForgeBakedModel)this.guiModel).handlePerspective(type, poseStack);
        }
